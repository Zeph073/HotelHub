...
public class BuyBreakfastDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_breakfast_details);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(BuyBreakfastDetailsActivity.this, BuyBreakfastActivity.class));
            }
        });
