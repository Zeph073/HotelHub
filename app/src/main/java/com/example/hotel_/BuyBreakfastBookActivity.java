...
public class BuyBreakfastBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buy_breakfast_book);
        ...
        btnOrder.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity( new Intent(BuyBreakfastBookActivity.this, MainDashboardActivity.class));
            }
        });
    }
}